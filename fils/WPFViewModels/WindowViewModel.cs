...
namespace RadioArchive
{
    ...
    public class WindowViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// The window re-sizer helper that keeps the window size correct in various states
        /// </summary>
        ...
        /// <summary>
        /// Indicate if this window is main or not 
        /// </summary>
        ...
        /// </summary>
        public double WindowMinimumWidth { get; set; } = 520;
        ...
        /// <summary>
        /// Indicates if window is maximized 
        /// </summary>
        ...
        public WindowViewModel(Window window)
        {
            ...
            mWindow.SizeChanged += (o, e) =>
            {
                // Set the property based on window state 
                WindowMaximized = mWindow.WindowState == WindowState.Maximized;

                // Hide if we reach the minimum window width and also if the side menu already collapsed  
                if (mWindow.ActualWidth <= WindowMinimumWidth)
                    ViewModelApplication.SideMenuVisible = false;
                else
